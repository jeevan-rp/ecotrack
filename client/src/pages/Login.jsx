  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="glass-panel p-8 w-full max-w-md relative overflow-hidden">
        <div className="absolute top-[-20%] right-[-20%] w-64 h-64 bg-accent-green opacity-10 rounded-full blur-[80px]"></div>
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-mint text-sm mt-2">Log in to track your carbon footprint</p>
        </div>
        ...
        <p className="text-center text-mint text-sm mt-6">
          Don't have an account? <Link to="/register" className="text-accent-green hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
